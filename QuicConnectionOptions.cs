...
using System;
using static CSharp.Quic.ThrowHelper;
...
public abstract class QuicConnectionOptions
{
    ...
    /// <summary>
    /// Gets or sets the congestion control algorithm to use for this connection.
    /// </summary>
    /// <remarks>
    /// Default is <see cref="QuicCongestionControlAlgorithm.Cubic"/>.
    /// BBR may provide better performance in high-latency or high-bandwidth scenarios.
    /// </remarks>
